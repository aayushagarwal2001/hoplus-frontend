...
class Patient extends Component {
    ...
    async uploadFile(event)
    {
        ...
        try {
            ...
            const hash = await ipfs.put([this.state.file],{wrapWithDirectory:false})
            this.updateFileHash(this.state.file.name,this.state.file.type,hash)
    ...
    render() {
        ...
        return (
            <div className='container-fluid' >
                <div className='row-1 mt-3' style={{border: '1px solid black',height:'10%'}}>
                ...
                <div className='row  mt-3' style={{paddingTop:'10px'}}>    
                    <div className='col-3 mt-2' style={{border: '1px solid black'}}>
                    <h6>Grant Access</h6>
                        <Card bordered={true}>
                            <div style={flexStyle}>
                    ...
                    <div className='col-3 mt-2' style={{height: "310px",border: '1px solid black'}}>
                    <h6>Upload File</h6>
                        <Card bordered={true}>
                    ...
                    <div className='col-4 mt-2' style={{height: "310px", width:'25%', overflow:'auto',border: '1px solid black'}}>
